<div id ="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="" target="_blank">Faiq Naveed & M.Attiq Haidery</a></span>
            </div>
        </div>
    </div>
</div>
...
<script src="js/sweetalert.min.js"></script>
       <!-- <script>
            swal({
            title: "Thankyou!",
            text: "Your order will be delivered in 4 working days.",
            icon: "success",
            button: "Ok!",
            });
        </script>  -->
