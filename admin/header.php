                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3" id="admin-menu">
                         <ul class="menu-list">
                            ...
                            <li <?php if(basename($_SERVER['PHP_SELF']) == "category.php") echo 'class="active"'; ?>><a href="category.php">Product Types</a></li>
                            <li <?php if(basename($_SERVER['PHP_SELF']) == "sub_category.php") echo 'class="active"'; ?>><a href="sub_category.php">Categories</a></li>
